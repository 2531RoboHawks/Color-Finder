...
public class ColorFinderAutoRGB {
	...
	public ColorFinderAutoRGB(String s, int n) {
		if (s == null) {
		...
		view.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				// TODO Auto-generated method stub
				double rx = view.getWidth() / 640;
				double ry = view.getHeight() / 480;
				px1 = (int) ((e.getX() / rx) - view.getX());
				py1 = (int) ((e.getY() / ry) - view.getY());
			...
			public void mouseReleased(MouseEvent e) {
				...
				double rx = view.getWidth() / 640;
				double ry = view.getHeight() / 480;
				px2 = (int) ((e.getX() * rx) - view.getX());
				py2 = (int) ((e.getY() * ry) - view.getY());
		...
		while (!e) {
			...
			Imgproc.circle(mat, new Point(px2, py2), 2, new Scalar(255, 0, 255), 2);
			Imgproc.circle(mat, new Point(px1, py1), 2, new Scalar(255, 0, 255), 2);
	...
	public static void main(String[] args) {
		if (args.length > 0) {
			new ColorFinderAutoRGB(args[0], 0);
		} else {
			new ColorFinderAutoRGB(null, 0);
		}
	}
